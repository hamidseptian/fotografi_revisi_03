...
<div class="col-lg-6 col-sm-6">
	...
	<div class="col-lg-6 product-details">
		...
		<a href="form/jasa/simpan_order_jasa.php?tgl=<?php echo $tgl ?>&idj=<?php echo $idj ?>&k=<?php echo $kegiatan ?>&lama=<?php echo $lama ?>&jambook=<?php echo $jambook ?>&tgl_selesai=<?php echo $tgl_selesai ?>" class="btn btn-info btn-xs">Masuk Ke Keranjang</a>
	</div>
