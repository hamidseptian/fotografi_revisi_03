...
<?php
  ...
  ?>
	...
	<div class="col-lg-6 product-details">
		...
		<a href="form/jasa/simpan_order_jasa.php?tgl=<?php echo $tgl ?>&idj=<?php echo $idj ?>&k=<?php echo $kegiatan ?>&lama=<?php echo $lama ?>&jambook=<?php echo $jambook ?>" class="btn btn-info">Masuk Ke Keranjang</a>
	</div>
