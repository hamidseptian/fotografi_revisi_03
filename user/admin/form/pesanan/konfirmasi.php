...
$q2 = mysqli_query($conn, "INSERT into tagihan (id_tagihan, id_pelanggan, nama_tagihan, jumlah_tagihan, waktu_create) values('$idt', '$idpel','Order Jasa Cetak Foto','$biaya','$timestamp')");
?>
<script type="text/javascript">
	alert('Pesanan Di Konfirmasi');
	window.location.href='../../?a=detail_pesanan&idp=<?php echo $idpel ?>&waktu=<?php echo $timestamp ?>&via=Offline'
</script>