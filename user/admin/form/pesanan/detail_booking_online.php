...
<div class="pull-right"> 
	<?php if ($status=='Dalam Proses') { ?>
		<a href="form/pesanan/laksanakan_acara.php?id_booking=<?php echo $id_booking ?>&idp=<?php echo $id ?>" class="btn btn-info">Laksanakan Acara</a>
	<?php }else if ($status=='Berlangsung') {  ?>
		<a href="form/pesanan/selesai_acara.php?id_booking=<?php echo $id_booking ?>&idp=<?php echo $id ?>" class="btn btn-info">Selesai Acara</a>
	<?php } ?>
