...
<div class="col-md-4">
	...
	<?php } ?>
	<a href="form/pesanan/proses_order.php?idpel=<?php echo $id ?>&idt=<?php echo $id_tagihan ?>&waktu=<?php echo $waktu ?>" class="btn btn-info btn-xs" onclick="return confirm('Proses Order.??')">Proses</a>
